...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	fb8080e7          	jalr	-72(ra) # 80006012 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	058080e7          	jalr	88(ra) # 800060c6 <release>
}
    ...
    8000008e:	a4c080e7          	jalr	-1460(ra) # 80005ad6 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	e8e080e7          	jalr	-370(ra) # 80005f82 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	ee6080e7          	jalr	-282(ra) # 80006012 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	f82080e7          	jalr	-126(ra) # 800060c6 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	f58080e7          	jalr	-168(ra) # 800060c6 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000358:	7cc080e7          	jalr	1996(ra) # 80005b20 <printf>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    8000048a:	650080e7          	jalr	1616(ra) # 80005ad6 <panic>
...
00000000800005e0 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000060c:	4ce080e7          	jalr	1230(ra) # 80005ad6 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    80000866:	274080e7          	jalr	628(ra) # 80005ad6 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009a8:	132080e7          	jalr	306(ra) # 80005ad6 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000afe:	fdc080e7          	jalr	-36(ra) # 80005ad6 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000d62:	d78080e7          	jalr	-648(ra) # 80005ad6 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000d8e:	1f8080e7          	jalr	504(ra) # 80005f82 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000da6:	1e0080e7          	jalr	480(ra) # 80005f82 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000ddc:	1aa080e7          	jalr	426(ra) # 80005f82 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000e50:	17a080e7          	jalr	378(ra) # 80005fc6 <push_off>
  ...
  pop_off();
    ...
    80000e6a:	200080e7          	jalr	512(ra) # 80006066 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000e8e:	23c080e7          	jalr	572(ra) # 800060c6 <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000eda:	13c080e7          	jalr	316(ra) # 80006012 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000ef4:	1d6080e7          	jalr	470(ra) # 800060c6 <release>
}
...
000000008000104c <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000106e:	fa8080e7          	jalr	-88(ra) # 80006012 <acquire>
    if(p->state == UNUSED) {
    ...
    8000107c:	04e080e7          	jalr	78(ra) # 800060c6 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    800010fa:	fd0080e7          	jalr	-48(ra) # 800060c6 <release>
    return 0;
    ...
    80001112:	fb8080e7          	jalr	-72(ra) # 800060c6 <release>
    return 0;
...
000000008000111a <userinit>:
{
  ...
  release(&p->lock);
    ...
    8000118e:	f3c080e7          	jalr	-196(ra) # 800060c6 <release>
}
...
0000000080001210 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012ac:	e1e080e7          	jalr	-482(ra) # 800060c6 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    800012fa:	dd0080e7          	jalr	-560(ra) # 800060c6 <release>
  acquire(&wait_lock);
    ...
    8000130c:	d0a080e7          	jalr	-758(ra) # 80006012 <acquire>
  np->parent = p;
    80001310:	035a3c23          	sd	s5,56(s4)
  release(&wait_lock);
    80001314:	8526                	mv	a0,s1
    80001316:	00005097          	auipc	ra,0x5
    8000131a:	db0080e7          	jalr	-592(ra) # 800060c6 <release>
  acquire(&np->lock);
    8000131e:	8552                	mv	a0,s4
    80001320:	00005097          	auipc	ra,0x5
    80001324:	cf2080e7          	jalr	-782(ra) # 80006012 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001334:	d96080e7          	jalr	-618(ra) # 800060c6 <release>
}
...
0000000080001350 <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800013b8:	d12080e7          	jalr	-750(ra) # 800060c6 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800013ca:	c4c080e7          	jalr	-948(ra) # 80006012 <acquire>
      if(p->state == RUNNABLE) {
...
00000000800013f0 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    8000140c:	b90080e7          	jalr	-1136(ra) # 80005f98 <holding>
...
00000000800014c6 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800014de:	b38080e7          	jalr	-1224(ra) # 80006012 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    800014f4:	bd6080e7          	jalr	-1066(ra) # 800060c6 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    80001522:	af4080e7          	jalr	-1292(ra) # 80006012 <acquire>
  release(lk);
    80001526:	854a                	mv	a0,s2
    80001528:	00005097          	auipc	ra,0x5
    8000152c:	b9e080e7          	jalr	-1122(ra) # 800060c6 <release>
  ...
  release(&p->lock);
    ...
    8000154a:	b80080e7          	jalr	-1152(ra) # 800060c6 <release>
  acquire(lk);
    8000154e:	854a                	mv	a0,s2
    80001550:	00005097          	auipc	ra,0x5
    80001554:	ac2080e7          	jalr	-1342(ra) # 80006012 <acquire>
}
...
0000000080001566 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80001596:	a80080e7          	jalr	-1408(ra) # 80006012 <acquire>
    havekids = 0;
    ...
    80001634:	9e2080e7          	jalr	-1566(ra) # 80006012 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001644:	a86080e7          	jalr	-1402(ra) # 800060c6 <release>
        havekids = 1;
    ...
    80001660:	a6a080e7          	jalr	-1430(ra) # 800060c6 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016be:	a0c080e7          	jalr	-1524(ra) # 800060c6 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016dc:	93a080e7          	jalr	-1734(ra) # 80006012 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
000000008000175e <exit>:
{
  ...
  if(p == initproc)
    ...
    8000179a:	340080e7          	jalr	832(ra) # 80005ad6 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    800017e4:	832080e7          	jalr	-1998(ra) # 80006012 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    80001804:	812080e7          	jalr	-2030(ra) # 80006012 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001818:	8b2080e7          	jalr	-1870(ra) # 800060c6 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001830:	2aa080e7          	jalr	682(ra) # 80005ad6 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000185a:	7bc080e7          	jalr	1980(ra) # 80006012 <acquire>
    if(p->pid == pid){
    ...
    8000186a:	860080e7          	jalr	-1952(ra) # 800060c6 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000188c:	83e080e7          	jalr	-1986(ra) # 800060c6 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001974:	1b0080e7          	jalr	432(ra) # 80005b20 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800019b6:	16e080e7          	jalr	366(ra) # 80005b20 <printf>
    printf("\n");
    800019ba:	8552                	mv	a0,s4
    800019bc:	00004097          	auipc	ra,0x4
    800019c0:	164080e7          	jalr	356(ra) # 80005b20 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001a86:	500080e7          	jalr	1280(ra) # 80005f82 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001b60:	4b6080e7          	jalr	1206(ra) # 80006012 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001b80:	54a080e7          	jalr	1354(ra) # 800060c6 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001be8:	f3c080e7          	jalr	-196(ra) # 80005b20 <printf>
      plic_complete(irq);
    ...
    80001bfe:	338080e7          	jalr	824(ra) # 80005f32 <uartintr>
...
0000000080001c30 <usertrap>:
{
  ...
  usertrapret();
    ...
    80001cb2:	e28080e7          	jalr	-472(ra) # 80005ad6 <panic>
      exit(-1);
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001ce6:	e3e080e7          	jalr	-450(ra) # 80005b20 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001cfe:	e26080e7          	jalr	-474(ra) # 80005b20 <printf>
    p->killed = 1;
...
0000000080001d24 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001d7e:	d5c080e7          	jalr	-676(ra) # 80005ad6 <panic>
    ...
    80001d8e:	d4c080e7          	jalr	-692(ra) # 80005ad6 <panic>
    printf("scause %p\n", scause);
    ...
    80001da0:	d84080e7          	jalr	-636(ra) # 80005b20 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001e54:	c86080e7          	jalr	-890(ra) # 80005ad6 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80001fbc:	b68080e7          	jalr	-1176(ra) # 80005b20 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    800020e0:	f36080e7          	jalr	-202(ra) # 80006012 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    80002134:	f96080e7          	jalr	-106(ra) # 800060c6 <release>
  return 0;
    ...
    80002156:	f74080e7          	jalr	-140(ra) # 800060c6 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800021a6:	e70080e7          	jalr	-400(ra) # 80006012 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    800021be:	f0c080e7          	jalr	-244(ra) # 800060c6 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800021f6:	d90080e7          	jalr	-624(ra) # 80005f82 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000227e:	d98080e7          	jalr	-616(ra) # 80006012 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    800022be:	e0c080e7          	jalr	-500(ra) # 800060c6 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    800022fc:	7de080e7          	jalr	2014(ra) # 80005ad6 <panic>
      b->dev = dev;
    ...
    8000231c:	dae080e7          	jalr	-594(ra) # 800060c6 <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    8000238c:	74e080e7          	jalr	1870(ra) # 80005ad6 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800023c4:	c52080e7          	jalr	-942(ra) # 80006012 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000240e:	cbc080e7          	jalr	-836(ra) # 800060c6 <release>
}
    ...
    8000242a:	6b0080e7          	jalr	1712(ra) # 80005ad6 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002446:	bd0080e7          	jalr	-1072(ra) # 80006012 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    8000245c:	c6e080e7          	jalr	-914(ra) # 800060c6 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002482:	b94080e7          	jalr	-1132(ra) # 80006012 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002498:	c32080e7          	jalr	-974(ra) # 800060c6 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    8000251e:	5bc080e7          	jalr	1468(ra) # 80005ad6 <panic>
...
0000000080002522 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800025e4:	4f6080e7          	jalr	1270(ra) # 80005ad6 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    8000272a:	3b0080e7          	jalr	944(ra) # 80005ad6 <panic>
...
000000008000272e <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000274e:	8c8080e7          	jalr	-1848(ra) # 80006012 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002794:	936080e7          	jalr	-1738(ra) # 800060c6 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    800027c4:	906080e7          	jalr	-1786(ra) # 800060c6 <release>
}
    ...
    800027e6:	2f4080e7          	jalr	756(ra) # 80005ad6 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    80002866:	274080e7          	jalr	628(ra) # 80005ad6 <panic>
...
000000008000286a <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    8000288c:	6fa080e7          	jalr	1786(ra) # 80005f82 <initlock>
  for(i = 0; i < NINODE; i++) {
...
00000000800028ca <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    8000294a:	190080e7          	jalr	400(ra) # 80005ad6 <panic>
...
0000000080002a24 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002a3c:	5da080e7          	jalr	1498(ra) # 80006012 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002a52:	678080e7          	jalr	1656(ra) # 800060c6 <release>
}
...
0000000080002a62 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002a9e:	03c080e7          	jalr	60(ra) # 80005ad6 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002b20:	fba080e7          	jalr	-70(ra) # 80005ad6 <panic>
...
0000000080002b24 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002b6c:	f6e080e7          	jalr	-146(ra) # 80005ad6 <panic>
...
0000000080002c1c <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002c36:	3e0080e7          	jalr	992(ra) # 80006012 <acquire>
  ...
  release(&itable.lock);
    ...
    80002c54:	476080e7          	jalr	1142(ra) # 800060c6 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002c88:	442080e7          	jalr	1090(ra) # 800060c6 <release>
    itrunc(ip);
    ...
    80002cbe:	358080e7          	jalr	856(ra) # 80006012 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80002f7c:	b5e080e7          	jalr	-1186(ra) # 80005ad6 <panic>
    ...
    80002f8c:	b4e080e7          	jalr	-1202(ra) # 80005ad6 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
0000000080003390 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    800033b8:	bce080e7          	jalr	-1074(ra) # 80005f82 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000344c:	bca080e7          	jalr	-1078(ra) # 80006012 <acquire>
  while(1){
    if(log.committing){
    ...
    800034a4:	c26080e7          	jalr	-986(ra) # 800060c6 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d4:	b42080e7          	jalr	-1214(ra) # 80006012 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    800034fc:	bce080e7          	jalr	-1074(ra) # 800060c6 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003514:	b02080e7          	jalr	-1278(ra) # 80006012 <acquire>
    log.committing = 0;
    ...
    8000352c:	b9e080e7          	jalr	-1122(ra) # 800060c6 <release>
}
    ...
    8000353e:	59c080e7          	jalr	1436(ra) # 80005ad6 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    8000355a:	b70080e7          	jalr	-1168(ra) # 800060c6 <release>
}
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003628:	9ee080e7          	jalr	-1554(ra) # 80006012 <acquire>
  ...
  release(&log.lock);
    ...
    800036e2:	9e8080e7          	jalr	-1560(ra) # 800060c6 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003710:	876080e7          	jalr	-1930(ra) # 80005f82 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003744:	8d2080e7          	jalr	-1838(ra) # 80006012 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    80003772:	958080e7          	jalr	-1704(ra) # 800060c6 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000379a:	87c080e7          	jalr	-1924(ra) # 80006012 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    800037b6:	914080e7          	jalr	-1772(ra) # 800060c6 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037e0:	836080e7          	jalr	-1994(ra) # 80006012 <acquire>
  ...
  release(&lk->lk);
    ...
    800037f0:	8da080e7          	jalr	-1830(ra) # 800060c6 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003838:	74e080e7          	jalr	1870(ra) # 80005f82 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    8000385a:	7bc080e7          	jalr	1980(ra) # 80006012 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003886:	844080e7          	jalr	-1980(ra) # 800060c6 <release>
  return 0;
    ...
    8000389e:	82c080e7          	jalr	-2004(ra) # 800060c6 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800038c6:	750080e7          	jalr	1872(ra) # 80006012 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800038e0:	7ea080e7          	jalr	2026(ra) # 800060c6 <release>
  return f;
}
    ...
    800038fc:	1de080e7          	jalr	478(ra) # 80005ad6 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003920:	6f6080e7          	jalr	1782(ra) # 80006012 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000395a:	770080e7          	jalr	1904(ra) # 800060c6 <release>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003aec:	fee080e7          	jalr	-18(ra) # 80005ad6 <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  return ret;
    ...
    80003c20:	eba080e7          	jalr	-326(ra) # 80005ad6 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003c90:	2f6080e7          	jalr	758(ra) # 80005f82 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003d1e:	2f8080e7          	jalr	760(ra) # 80006012 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003d42:	388080e7          	jalr	904(ra) # 800060c6 <release>
    kfree((char*)pi);
    ...
    80003d74:	356080e7          	jalr	854(ra) # 800060c6 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003da8:	26e080e7          	jalr	622(ra) # 80006012 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003dc4:	306080e7          	jalr	774(ra) # 800060c6 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003e66:	264080e7          	jalr	612(ra) # 800060c6 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e96:	180080e7          	jalr	384(ra) # 80006012 <acquire>
  ...
  release(&pi->lock);
    ...
    80003f2a:	1a0080e7          	jalr	416(ra) # 800060c6 <release>
  return i;
}
    ...
    80003f4a:	180080e7          	jalr	384(ra) # 800060c6 <release>
      return -1;
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    8000405c:	a7e080e7          	jalr	-1410(ra) # 80005ad6 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
  ...
  ustack[argc] = 0;
    ...
    8000417c:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffd8d50>
    80004180:	97a2                	add	a5,a5,s0
    80004182:	f007b023          	sd	zero,-256(a5)
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000449c:	63e080e7          	jalr	1598(ra) # 80005ad6 <panic>
    dp->nlink++;  // for ".."
...
000000008000480a <sys_unlink>:
{
  ...
  return 0;
    ...
    80004936:	1a4080e7          	jalr	420(ra) # 80005ad6 <panic>
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80004d2a:	0c054b63          	bltz	a0,80004e00 <sys_exec+0xfc>
    ...
    80004d3c:	0c054263          	bltz	a0,80004e00 <sys_exec+0xfc>
  }
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80004db2:	c531                	beqz	a0,80004dfe <sys_exec+0xfa>
    kfree(argv[i]);
  ...
  return -1;
    ...
    80004dc4:	a835                	j	80004e00 <sys_exec+0xfc>
      argv[i] = 0;
    80004dc6:	0a8e                	slli	s5,s5,0x3
    80004dc8:	fc0a8793          	addi	a5,s5,-64 # ffffffffffffefc0 <end+0xffffffff7ffd8d80>
    80004dcc:	00878ab3          	add	s5,a5,s0
    80004dd0:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80004dd4:	e4040593          	addi	a1,s0,-448
    80004dd8:	f4040513          	addi	a0,s0,-192
    80004ddc:	fffff097          	auipc	ra,0xfffff
    80004de0:	176080e7          	jalr	374(ra) # 80003f52 <exec>
    80004de4:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004de6:	10048993          	addi	s3,s1,256
    80004dea:	6088                	ld	a0,0(s1)
    80004dec:	c911                	beqz	a0,80004e00 <sys_exec+0xfc>
    kfree(argv[i]);
    80004dee:	ffffb097          	auipc	ra,0xffffb
    80004df2:	22e080e7          	jalr	558(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004df6:	04a1                	addi	s1,s1,8
    80004df8:	ff3499e3          	bne	s1,s3,80004dea <sys_exec+0xe6>
    80004dfc:	a011                	j	80004e00 <sys_exec+0xfc>
  return -1;
    80004dfe:	597d                	li	s2,-1
}
    80004e00:	854a                	mv	a0,s2
    80004e02:	60be                	ld	ra,456(sp)
    80004e04:	641e                	ld	s0,448(sp)
    80004e06:	74fa                	ld	s1,440(sp)
    80004e08:	795a                	ld	s2,432(sp)
    80004e0a:	79ba                	ld	s3,424(sp)
    80004e0c:	7a1a                	ld	s4,416(sp)
    80004e0e:	6afa                	ld	s5,408(sp)
    80004e10:	6179                	addi	sp,sp,464
    80004e12:	8082                	ret

0000000080004e14 <sys_pipe>:

uint64
sys_pipe(void)
{
    80004e14:	7139                	addi	sp,sp,-64
    80004e16:	fc06                	sd	ra,56(sp)
    80004e18:	f822                	sd	s0,48(sp)
    80004e1a:	f426                	sd	s1,40(sp)
    80004e1c:	0080                	addi	s0,sp,64
  uint64 fdarray; // user pointer to array of two integers
  struct file *rf, *wf;
  int fd0, fd1;
  struct proc *p = myproc();
    80004e1e:	ffffc097          	auipc	ra,0xffffc
    80004e22:	024080e7          	jalr	36(ra) # 80000e42 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80004e32:	0e6080e7          	jalr	230(ra) # 80001f14 <argaddr>
    return -1;
    80004e36:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    80004e38:	0e054063          	bltz	a0,80004f18 <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    80004e3c:	fc840593          	addi	a1,s0,-56
    80004e40:	fd040513          	addi	a0,s0,-48
    80004e44:	fffff097          	auipc	ra,0xfffff
    80004e48:	dec080e7          	jalr	-532(ra) # 80003c30 <pipealloc>
    return -1;
    80004e4c:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    80004e4e:	0c054563          	bltz	a0,80004f18 <sys_pipe+0x104>
  fd0 = -1;
    80004e52:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80004e56:	fd043503          	ld	a0,-48(s0)
    80004e5a:	fffff097          	auipc	ra,0xfffff
    80004e5e:	508080e7          	jalr	1288(ra) # 80004362 <fdalloc>
    80004e62:	fca42223          	sw	a0,-60(s0)
    80004e66:	08054c63          	bltz	a0,80004efe <sys_pipe+0xea>
    80004e6a:	fc843503          	ld	a0,-56(s0)
    80004e6e:	fffff097          	auipc	ra,0xfffff
    80004e72:	4f4080e7          	jalr	1268(ra) # 80004362 <fdalloc>
    80004e76:	fca42023          	sw	a0,-64(s0)
    80004e7a:	06054863          	bltz	a0,80004eea <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80004e7e:	4691                	li	a3,4
    80004e80:	fc440613          	addi	a2,s0,-60
    80004e84:	fd843583          	ld	a1,-40(s0)
    80004e88:	68a8                	ld	a0,80(s1)
    80004e8a:	ffffc097          	auipc	ra,0xffffc
    80004e8e:	c78080e7          	jalr	-904(ra) # 80000b02 <copyout>
    80004e92:	02054063          	bltz	a0,80004eb2 <sys_pipe+0x9e>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    80004e96:	4691                	li	a3,4
    80004e98:	fc040613          	addi	a2,s0,-64
    80004e9c:	fd843583          	ld	a1,-40(s0)
    80004ea0:	0591                	addi	a1,a1,4
    80004ea2:	68a8                	ld	a0,80(s1)
    80004ea4:	ffffc097          	auipc	ra,0xffffc
    80004ea8:	c5e080e7          	jalr	-930(ra) # 80000b02 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80004eae:	06055563          	bgez	a0,80004f18 <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    80004eb2:	fc442783          	lw	a5,-60(s0)
    80004eb6:	07e9                	addi	a5,a5,26
    80004eb8:	078e                	slli	a5,a5,0x3
    80004eba:	97a6                	add	a5,a5,s1
    80004ebc:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    80004ec0:	fc042503          	lw	a0,-64(s0)
    80004ec4:	0569                	addi	a0,a0,26
    80004ec6:	050e                	slli	a0,a0,0x3
    80004ec8:	9526                	add	a0,a0,s1
    80004eca:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80004ece:	fd043503          	ld	a0,-48(s0)
    80004ed2:	fffff097          	auipc	ra,0xfffff
    80004ed6:	a2e080e7          	jalr	-1490(ra) # 80003900 <fileclose>
    fileclose(wf);
    80004eda:	fc843503          	ld	a0,-56(s0)
    80004ede:	fffff097          	auipc	ra,0xfffff
    80004ee2:	a22080e7          	jalr	-1502(ra) # 80003900 <fileclose>
    return -1;
    80004ee6:	57fd                	li	a5,-1
    80004ee8:	a805                	j	80004f18 <sys_pipe+0x104>
    if(fd0 >= 0)
    80004eea:	fc442783          	lw	a5,-60(s0)
    80004eee:	0007c863          	bltz	a5,80004efe <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    80004ef2:	01a78513          	addi	a0,a5,26
    80004ef6:	050e                	slli	a0,a0,0x3
    80004ef8:	9526                	add	a0,a0,s1
    80004efa:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80004efe:	fd043503          	ld	a0,-48(s0)
    80004f02:	fffff097          	auipc	ra,0xfffff
    80004f06:	9fe080e7          	jalr	-1538(ra) # 80003900 <fileclose>
    fileclose(wf);
    80004f0a:	fc843503          	ld	a0,-56(s0)
    80004f0e:	fffff097          	auipc	ra,0xfffff
    80004f12:	9f2080e7          	jalr	-1550(ra) # 80003900 <fileclose>
    return -1;
...
0000000080005122 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005140:	e46080e7          	jalr	-442(ra) # 80005f82 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    80005242:	898080e7          	jalr	-1896(ra) # 80005ad6 <panic>
    ...
    80005252:	888080e7          	jalr	-1912(ra) # 80005ad6 <panic>
    ...
    80005262:	878080e7          	jalr	-1928(ra) # 80005ad6 <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800052a2:	d74080e7          	jalr	-652(ra) # 80006012 <acquire>
  for(int i = 0; i < 3; i++){
    ...
    80005320:	f8040a13          	addi	s4,s0,-128
{
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005444:	c86080e7          	jalr	-890(ra) # 800060c6 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005506:	b10080e7          	jalr	-1264(ra) # 80006012 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005598:	b32080e7          	jalr	-1230(ra) # 800060c6 <release>
}
    ...
    800055b4:	526080e7          	jalr	1318(ra) # 80005ad6 <panic>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    800056dc:	77c080e7          	jalr	1916(ra) # 80005e54 <uartputc>
  for(i = 0; i < n; i++){
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80005732:	8e4080e7          	jalr	-1820(ra) # 80006012 <acquire>
  while(n > 0){
  ...
  release(&cons.lock);
    ...
    800057c8:	902080e7          	jalr	-1790(ra) # 800060c6 <release>
  ...
  return target - n;
    ...
    800057de:	8ec080e7          	jalr	-1812(ra) # 800060c6 <release>
        return -1;
...
0000000080005812 <consputc>:
{
  ...
  if(c == BACKSPACE){
    ...
    80005826:	560080e7          	jalr	1376(ra) # 80005d82 <uartputc_sync>
}
    ...
    80005838:	54e080e7          	jalr	1358(ra) # 80005d82 <uartputc_sync>
    8000583c:	02000513          	li	a0,32
    80005840:	00000097          	auipc	ra,0x0
    80005844:	542080e7          	jalr	1346(ra) # 80005d82 <uartputc_sync>
    80005848:	4521                	li	a0,8
    8000584a:	00000097          	auipc	ra,0x0
    8000584e:	538080e7          	jalr	1336(ra) # 80005d82 <uartputc_sync>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    8000586e:	7a8080e7          	jalr	1960(ra) # 80006012 <acquire>
  ...
  release(&cons.lock);
    ...
    8000589c:	82e080e7          	jalr	-2002(ra) # 800060c6 <release>
}
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005a02:	584080e7          	jalr	1412(ra) # 80005f82 <initlock>

  uartinit();
    80005a06:	00000097          	auipc	ra,0x0
    80005a0a:	32c080e7          	jalr	812(ra) # 80005d32 <uartinit>
...
printint(int xx, int base, int sign)
{
  ...
  if(sign && (sign = xx < 0))
    ...
    80005a40:	08054763          	bltz	a0,80005ace <printint+0x9c>
    x = -xx;
  else
    x = xx;
  ...
  if(sign)
    80005a7c:	00088c63          	beqz	a7,80005a94 <printint+0x62>
    buf[i++] = '-';
    80005a80:	fe070793          	addi	a5,a4,-32
    80005a84:	00878733          	add	a4,a5,s0
    80005a88:	02d00793          	li	a5,45
    80005a8c:	fef70823          	sb	a5,-16(a4)
    80005a90:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80005a94:	02e05763          	blez	a4,80005ac2 <printint+0x90>
    80005a98:	fd040793          	addi	a5,s0,-48
    80005a9c:	00e784b3          	add	s1,a5,a4
    80005aa0:	fff78913          	addi	s2,a5,-1
    80005aa4:	993a                	add	s2,s2,a4
    80005aa6:	377d                	addiw	a4,a4,-1
    80005aa8:	1702                	slli	a4,a4,0x20
    80005aaa:	9301                	srli	a4,a4,0x20
    80005aac:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80005ab0:	fff4c503          	lbu	a0,-1(s1)
    80005ab4:	00000097          	auipc	ra,0x0
    80005ab8:	d5e080e7          	jalr	-674(ra) # 80005812 <consputc>
  while(--i >= 0)
    80005abc:	14fd                	addi	s1,s1,-1
    80005abe:	ff2499e3          	bne	s1,s2,80005ab0 <printint+0x7e>
}
    80005ac2:	70a2                	ld	ra,40(sp)
    80005ac4:	7402                	ld	s0,32(sp)
    80005ac6:	64e2                	ld	s1,24(sp)
    80005ac8:	6942                	ld	s2,16(sp)
    80005aca:	6145                	addi	sp,sp,48
    80005acc:	8082                	ret
    x = -xx;
    80005ace:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80005ad2:	4885                	li	a7,1
    x = -xx;
    80005ad4:	bf95                	j	80005a48 <printint+0x16>

0000000080005ad6 <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    ...
    80005adc:	e426                	sd	s1,8(sp)
    80005ade:	1000                	addi	s0,sp,32
    80005ae0:	84aa                	mv	s1,a0
  pr.locking = 0;
    80005ae2:	00020797          	auipc	a5,0x20
    80005ae6:	7007af23          	sw	zero,1822(a5) # 80026200 <pr+0x18>
  printf("panic: ");
    80005aea:	00003517          	auipc	a0,0x3
    80005aee:	cae50513          	addi	a0,a0,-850 # 80008798 <syscalls+0x3d0>
    80005af2:	00000097          	auipc	ra,0x0
    80005af6:	02e080e7          	jalr	46(ra) # 80005b20 <printf>
  printf(s);
    80005afa:	8526                	mv	a0,s1
    80005afc:	00000097          	auipc	ra,0x0
    80005b00:	024080e7          	jalr	36(ra) # 80005b20 <printf>
  printf("\n");
    80005b04:	00002517          	auipc	a0,0x2
    80005b08:	54450513          	addi	a0,a0,1348 # 80008048 <etext+0x48>
    80005b0c:	00000097          	auipc	ra,0x0
    80005b10:	014080e7          	jalr	20(ra) # 80005b20 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80005b14:	4785                	li	a5,1
    80005b16:	00003717          	auipc	a4,0x3
    80005b1a:	50f72323          	sw	a5,1286(a4) # 8000901c <panicked>
  for(;;)
    80005b1e:	a001                	j	80005b1e <panic+0x48>

0000000080005b20 <printf>:
{
    80005b20:	7131                	addi	sp,sp,-192
    80005b22:	fc86                	sd	ra,120(sp)
    80005b24:	f8a2                	sd	s0,112(sp)
    80005b26:	f4a6                	sd	s1,104(sp)
    80005b28:	f0ca                	sd	s2,96(sp)
    80005b2a:	ecce                	sd	s3,88(sp)
    80005b2c:	e8d2                	sd	s4,80(sp)
    80005b2e:	e4d6                	sd	s5,72(sp)
    80005b30:	e0da                	sd	s6,64(sp)
    80005b32:	fc5e                	sd	s7,56(sp)
    80005b34:	f862                	sd	s8,48(sp)
    80005b36:	f466                	sd	s9,40(sp)
    80005b38:	f06a                	sd	s10,32(sp)
    80005b3a:	ec6e                	sd	s11,24(sp)
    80005b3c:	0100                	addi	s0,sp,128
    80005b3e:	8a2a                	mv	s4,a0
    80005b40:	e40c                	sd	a1,8(s0)
    80005b42:	e810                	sd	a2,16(s0)
    80005b44:	ec14                	sd	a3,24(s0)
    80005b46:	f018                	sd	a4,32(s0)
    80005b48:	f41c                	sd	a5,40(s0)
    80005b4a:	03043823          	sd	a6,48(s0)
    80005b4e:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80005b52:	00020d97          	auipc	s11,0x20
    80005b56:	6aedad83          	lw	s11,1710(s11) # 80026200 <pr+0x18>
  if(locking)
    80005b5a:	020d9b63          	bnez	s11,80005b90 <printf+0x70>
  if (fmt == 0)
    80005b5e:	040a0263          	beqz	s4,80005ba2 <printf+0x82>
  va_start(ap, fmt);
    80005b62:	00840793          	addi	a5,s0,8
    80005b66:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80005b6a:	000a4503          	lbu	a0,0(s4)
    80005b6e:	14050f63          	beqz	a0,80005ccc <printf+0x1ac>
    80005b72:	4981                	li	s3,0
    if(c != '%'){
    80005b74:	02500a93          	li	s5,37
    switch(c){
    80005b78:	07000b93          	li	s7,112
  consputc('x');
    80005b7c:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80005b7e:	00003b17          	auipc	s6,0x3
    80005b82:	c42b0b13          	addi	s6,s6,-958 # 800087c0 <digits>
    switch(c){
    80005b86:	07300c93          	li	s9,115
    80005b8a:	06400c13          	li	s8,100
    80005b8e:	a82d                	j	80005bc8 <printf+0xa8>
    acquire(&pr.lock);
    80005b90:	00020517          	auipc	a0,0x20
    80005b94:	65850513          	addi	a0,a0,1624 # 800261e8 <pr>
    80005b98:	00000097          	auipc	ra,0x0
    80005b9c:	47a080e7          	jalr	1146(ra) # 80006012 <acquire>
    80005ba0:	bf7d                	j	80005b5e <printf+0x3e>
    panic("null fmt");
    80005ba2:	00003517          	auipc	a0,0x3
    80005ba6:	c0650513          	addi	a0,a0,-1018 # 800087a8 <syscalls+0x3e0>
    80005baa:	00000097          	auipc	ra,0x0
    80005bae:	f2c080e7          	jalr	-212(ra) # 80005ad6 <panic>
      consputc(c);
    80005bb2:	00000097          	auipc	ra,0x0
    80005bb6:	c60080e7          	jalr	-928(ra) # 80005812 <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80005bba:	2985                	addiw	s3,s3,1
    80005bbc:	013a07b3          	add	a5,s4,s3
    80005bc0:	0007c503          	lbu	a0,0(a5)
    80005bc4:	10050463          	beqz	a0,80005ccc <printf+0x1ac>
    if(c != '%'){
    80005bc8:	ff5515e3          	bne	a0,s5,80005bb2 <printf+0x92>
    c = fmt[++i] & 0xff;
    80005bcc:	2985                	addiw	s3,s3,1
    80005bce:	013a07b3          	add	a5,s4,s3
    80005bd2:	0007c783          	lbu	a5,0(a5)
    80005bd6:	0007849b          	sext.w	s1,a5
    if(c == 0)
    80005bda:	cbed                	beqz	a5,80005ccc <printf+0x1ac>
    switch(c){
    80005bdc:	05778a63          	beq	a5,s7,80005c30 <printf+0x110>
    80005be0:	02fbf663          	bgeu	s7,a5,80005c0c <printf+0xec>
    80005be4:	09978863          	beq	a5,s9,80005c74 <printf+0x154>
    80005be8:	07800713          	li	a4,120
    80005bec:	0ce79563          	bne	a5,a4,80005cb6 <printf+0x196>
      printint(va_arg(ap, int), 16, 1);
    80005bf0:	f8843783          	ld	a5,-120(s0)
    80005bf4:	00878713          	addi	a4,a5,8
    80005bf8:	f8e43423          	sd	a4,-120(s0)
    80005bfc:	4605                	li	a2,1
    80005bfe:	85ea                	mv	a1,s10
    80005c00:	4388                	lw	a0,0(a5)
    80005c02:	00000097          	auipc	ra,0x0
    80005c06:	e30080e7          	jalr	-464(ra) # 80005a32 <printint>
      break;
    80005c0a:	bf45                	j	80005bba <printf+0x9a>
    switch(c){
    80005c0c:	09578f63          	beq	a5,s5,80005caa <printf+0x18a>
    80005c10:	0b879363          	bne	a5,s8,80005cb6 <printf+0x196>
      printint(va_arg(ap, int), 10, 1);
    80005c14:	f8843783          	ld	a5,-120(s0)
    80005c18:	00878713          	addi	a4,a5,8
    80005c1c:	f8e43423          	sd	a4,-120(s0)
    80005c20:	4605                	li	a2,1
    80005c22:	45a9                	li	a1,10
    80005c24:	4388                	lw	a0,0(a5)
    80005c26:	00000097          	auipc	ra,0x0
    80005c2a:	e0c080e7          	jalr	-500(ra) # 80005a32 <printint>
      break;
    80005c2e:	b771                	j	80005bba <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80005c30:	f8843783          	ld	a5,-120(s0)
    80005c34:	00878713          	addi	a4,a5,8
    80005c38:	f8e43423          	sd	a4,-120(s0)
    80005c3c:	0007b903          	ld	s2,0(a5)
  consputc('0');
    80005c40:	03000513          	li	a0,48
    80005c44:	00000097          	auipc	ra,0x0
    80005c48:	bce080e7          	jalr	-1074(ra) # 80005812 <consputc>
  consputc('x');
    80005c4c:	07800513          	li	a0,120
    80005c50:	00000097          	auipc	ra,0x0
    80005c54:	bc2080e7          	jalr	-1086(ra) # 80005812 <consputc>
    80005c58:	84ea                	mv	s1,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80005c5a:	03c95793          	srli	a5,s2,0x3c
    80005c5e:	97da                	add	a5,a5,s6
    80005c60:	0007c503          	lbu	a0,0(a5)
    80005c64:	00000097          	auipc	ra,0x0
    80005c68:	bae080e7          	jalr	-1106(ra) # 80005812 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80005c6c:	0912                	slli	s2,s2,0x4
    80005c6e:	34fd                	addiw	s1,s1,-1
    80005c70:	f4ed                	bnez	s1,80005c5a <printf+0x13a>
    80005c72:	b7a1                	j	80005bba <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80005c74:	f8843783          	ld	a5,-120(s0)
    80005c78:	00878713          	addi	a4,a5,8
    80005c7c:	f8e43423          	sd	a4,-120(s0)
    80005c80:	6384                	ld	s1,0(a5)
    80005c82:	cc89                	beqz	s1,80005c9c <printf+0x17c>
      for(; *s; s++)
    80005c84:	0004c503          	lbu	a0,0(s1)
    80005c88:	d90d                	beqz	a0,80005bba <printf+0x9a>
        consputc(*s);
    80005c8a:	00000097          	auipc	ra,0x0
    80005c8e:	b88080e7          	jalr	-1144(ra) # 80005812 <consputc>
      for(; *s; s++)
    80005c92:	0485                	addi	s1,s1,1
    80005c94:	0004c503          	lbu	a0,0(s1)
    80005c98:	f96d                	bnez	a0,80005c8a <printf+0x16a>
    80005c9a:	b705                	j	80005bba <printf+0x9a>
        s = "(null)";
    80005c9c:	00003497          	auipc	s1,0x3
    80005ca0:	b0448493          	addi	s1,s1,-1276 # 800087a0 <syscalls+0x3d8>
      for(; *s; s++)
    80005ca4:	02800513          	li	a0,40
    80005ca8:	b7cd                	j	80005c8a <printf+0x16a>
      consputc('%');
    80005caa:	8556                	mv	a0,s5
    80005cac:	00000097          	auipc	ra,0x0
    80005cb0:	b66080e7          	jalr	-1178(ra) # 80005812 <consputc>
      break;
    80005cb4:	b719                	j	80005bba <printf+0x9a>
      consputc('%');
    80005cb6:	8556                	mv	a0,s5
    80005cb8:	00000097          	auipc	ra,0x0
    80005cbc:	b5a080e7          	jalr	-1190(ra) # 80005812 <consputc>
      consputc(c);
    80005cc0:	8526                	mv	a0,s1
    80005cc2:	00000097          	auipc	ra,0x0
    80005cc6:	b50080e7          	jalr	-1200(ra) # 80005812 <consputc>
      break;
    80005cca:	bdc5                	j	80005bba <printf+0x9a>
  if(locking)
    80005ccc:	020d9163          	bnez	s11,80005cee <printf+0x1ce>
}
    80005cd0:	70e6                	ld	ra,120(sp)
    80005cd2:	7446                	ld	s0,112(sp)
    80005cd4:	74a6                	ld	s1,104(sp)
    80005cd6:	7906                	ld	s2,96(sp)
    80005cd8:	69e6                	ld	s3,88(sp)
    80005cda:	6a46                	ld	s4,80(sp)
    80005cdc:	6aa6                	ld	s5,72(sp)
    80005cde:	6b06                	ld	s6,64(sp)
    80005ce0:	7be2                	ld	s7,56(sp)
    80005ce2:	7c42                	ld	s8,48(sp)
    80005ce4:	7ca2                	ld	s9,40(sp)
    80005ce6:	7d02                	ld	s10,32(sp)
    80005ce8:	6de2                	ld	s11,24(sp)
    80005cea:	6129                	addi	sp,sp,192
    80005cec:	8082                	ret
    release(&pr.lock);
    80005cee:	00020517          	auipc	a0,0x20
    80005cf2:	4fa50513          	addi	a0,a0,1274 # 800261e8 <pr>
    80005cf6:	00000097          	auipc	ra,0x0
    80005cfa:	3d0080e7          	jalr	976(ra) # 800060c6 <release>
}
    80005cfe:	bfc9                	j	80005cd0 <printf+0x1b0>

0000000080005d00 <printfinit>:
    ;
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80005d0a:	00020497          	auipc	s1,0x20
    80005d0e:	4de48493          	addi	s1,s1,1246 # 800261e8 <pr>
    80005d12:	00003597          	auipc	a1,0x3
    80005d16:	aa658593          	addi	a1,a1,-1370 # 800087b8 <syscalls+0x3f0>
    80005d1a:	8526                	mv	a0,s1
    80005d1c:	00000097          	auipc	ra,0x0
    80005d20:	266080e7          	jalr	614(ra) # 80005f82 <initlock>
  pr.locking = 1;
    80005d24:	4785                	li	a5,1
    80005d26:	cc9c                	sw	a5,24(s1)
}
...
uartinit(void)
{
  ...
  WriteReg(LCR, LCR_BAUD_LATCH);
    80005d42:	f8000713          	li	a4,-128
    80005d46:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80005d4a:	470d                	li	a4,3
    80005d4c:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80005d50:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80005d54:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80005d58:	469d                	li	a3,7
    80005d5a:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80005d5e:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80005d62:	00003597          	auipc	a1,0x3
    80005d66:	a7658593          	addi	a1,a1,-1418 # 800087d8 <digits+0x18>
    80005d6a:	00020517          	auipc	a0,0x20
    80005d6e:	49e50513          	addi	a0,a0,1182 # 80026208 <uart_tx_lock>
    80005d72:	00000097          	auipc	ra,0x0
    80005d76:	210080e7          	jalr	528(ra) # 80005f82 <initlock>
}
...
0000000080005d82 <uartputc_sync>:
...
uartputc_sync(int c)
{
  ...
  push_off();
    ...
    80005d92:	238080e7          	jalr	568(ra) # 80005fc6 <push_off>

  if(panicked){
    80005d96:	00003797          	auipc	a5,0x3
    80005d9a:	2867a783          	lw	a5,646(a5) # 8000901c <panicked>
    for(;;)
      ;
  }
  ...
  if(panicked){
    80005da2:	c391                	beqz	a5,80005da6 <uartputc_sync+0x24>
    for(;;)
    80005da4:	a001                	j	80005da4 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80005da6:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80005daa:	0207f793          	andi	a5,a5,32
    80005dae:	dfe5                	beqz	a5,80005da6 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80005db0:	0ff4f513          	andi	a0,s1,255
    80005db4:	100007b7          	lui	a5,0x10000
    80005db8:	00a78023          	sb	a0,0(a5) # 10000000 <_entry-0x70000000>

  pop_off();
    80005dbc:	00000097          	auipc	ra,0x0
    80005dc0:	2aa080e7          	jalr	682(ra) # 80006066 <pop_off>
}
...
uartstart()
{
  while(1){
    ...
    80005dce:	00003797          	auipc	a5,0x3
    80005dd2:	2527b783          	ld	a5,594(a5) # 80009020 <uart_tx_r>
    80005dd6:	00003717          	auipc	a4,0x3
    80005dda:	25273703          	ld	a4,594(a4) # 80009028 <uart_tx_w>
    80005dde:	06f70a63          	beq	a4,a5,80005e52 <uartstart+0x84>
{
    80005de2:	7139                	addi	sp,sp,-64
    80005de4:	fc06                	sd	ra,56(sp)
    80005de6:	f822                	sd	s0,48(sp)
    80005de8:	f426                	sd	s1,40(sp)
    80005dea:	f04a                	sd	s2,32(sp)
    80005dec:	ec4e                	sd	s3,24(sp)
    80005dee:	e852                	sd	s4,16(sp)
    80005df0:	e456                	sd	s5,8(sp)
    ...
    80005df4:	10000937          	lui	s2,0x10000
    ...
    80005df8:	00020a17          	auipc	s4,0x20
    80005dfc:	410a0a13          	addi	s4,s4,1040 # 80026208 <uart_tx_lock>
    uart_tx_r += 1;
    80005e00:	00003497          	auipc	s1,0x3
    80005e04:	22048493          	addi	s1,s1,544 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80005e08:	00003997          	auipc	s3,0x3
    80005e0c:	22098993          	addi	s3,s3,544 # 80009028 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80005e10:	00594703          	lbu	a4,5(s2) # 10000005 <_entry-0x6ffffffb>
    80005e14:	02077713          	andi	a4,a4,32
    80005e18:	c705                	beqz	a4,80005e40 <uartstart+0x72>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80005e1a:	01f7f713          	andi	a4,a5,31
    80005e1e:	9752                	add	a4,a4,s4
    80005e20:	01874a83          	lbu	s5,24(a4)
    uart_tx_r += 1;
    80005e24:	0785                	addi	a5,a5,1
    80005e26:	e09c                	sd	a5,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80005e28:	8526                	mv	a0,s1
    80005e2a:	ffffc097          	auipc	ra,0xffffc
    80005e2e:	864080e7          	jalr	-1948(ra) # 8000168e <wakeup>
    
    WriteReg(THR, c);
    80005e32:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80005e36:	609c                	ld	a5,0(s1)
    80005e38:	0009b703          	ld	a4,0(s3)
    80005e3c:	fcf71ae3          	bne	a4,a5,80005e10 <uartstart+0x42>
  }
}
    80005e40:	70e2                	ld	ra,56(sp)
    80005e42:	7442                	ld	s0,48(sp)
    80005e44:	74a2                	ld	s1,40(sp)
    80005e46:	7902                	ld	s2,32(sp)
    80005e48:	69e2                	ld	s3,24(sp)
    80005e4a:	6a42                	ld	s4,16(sp)
    80005e4c:	6aa2                	ld	s5,8(sp)
    80005e4e:	6121                	addi	sp,sp,64
    80005e50:	8082                	ret
    80005e52:	8082                	ret

0000000080005e54 <uartputc>:
{
    80005e54:	7179                	addi	sp,sp,-48
    80005e56:	f406                	sd	ra,40(sp)
    80005e58:	f022                	sd	s0,32(sp)
    80005e5a:	ec26                	sd	s1,24(sp)
    80005e5c:	e84a                	sd	s2,16(sp)
    80005e5e:	e44e                	sd	s3,8(sp)
    80005e60:	e052                	sd	s4,0(sp)
    80005e62:	1800                	addi	s0,sp,48
    80005e64:	8a2a                	mv	s4,a0
  acquire(&uart_tx_lock);
    80005e66:	00020517          	auipc	a0,0x20
    80005e6a:	3a250513          	addi	a0,a0,930 # 80026208 <uart_tx_lock>
    80005e6e:	00000097          	auipc	ra,0x0
    80005e72:	1a4080e7          	jalr	420(ra) # 80006012 <acquire>
  if(panicked){
    80005e76:	00003797          	auipc	a5,0x3
    80005e7a:	1a67a783          	lw	a5,422(a5) # 8000901c <panicked>
    80005e7e:	c391                	beqz	a5,80005e82 <uartputc+0x2e>
    for(;;)
    80005e80:	a001                	j	80005e80 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005e82:	00003717          	auipc	a4,0x3
    80005e86:	1a673703          	ld	a4,422(a4) # 80009028 <uart_tx_w>
    80005e8a:	00003797          	auipc	a5,0x3
    80005e8e:	1967b783          	ld	a5,406(a5) # 80009020 <uart_tx_r>
    80005e92:	02078793          	addi	a5,a5,32
    80005e96:	02e79b63          	bne	a5,a4,80005ecc <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80005e9a:	00020997          	auipc	s3,0x20
    80005e9e:	36e98993          	addi	s3,s3,878 # 80026208 <uart_tx_lock>
    80005ea2:	00003497          	auipc	s1,0x3
    80005ea6:	17e48493          	addi	s1,s1,382 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005eaa:	00003917          	auipc	s2,0x3
    80005eae:	17e90913          	addi	s2,s2,382 # 80009028 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80005eb2:	85ce                	mv	a1,s3
    80005eb4:	8526                	mv	a0,s1
    80005eb6:	ffffb097          	auipc	ra,0xffffb
    80005eba:	64c080e7          	jalr	1612(ra) # 80001502 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005ebe:	00093703          	ld	a4,0(s2)
    80005ec2:	609c                	ld	a5,0(s1)
    80005ec4:	02078793          	addi	a5,a5,32
    80005ec8:	fee785e3          	beq	a5,a4,80005eb2 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80005ecc:	00020497          	auipc	s1,0x20
    80005ed0:	33c48493          	addi	s1,s1,828 # 80026208 <uart_tx_lock>
    80005ed4:	01f77793          	andi	a5,a4,31
    80005ed8:	97a6                	add	a5,a5,s1
    80005eda:	01478c23          	sb	s4,24(a5)
      uart_tx_w += 1;
    80005ede:	0705                	addi	a4,a4,1
    80005ee0:	00003797          	auipc	a5,0x3
    80005ee4:	14e7b423          	sd	a4,328(a5) # 80009028 <uart_tx_w>
      uartstart();
    80005ee8:	00000097          	auipc	ra,0x0
    80005eec:	ee6080e7          	jalr	-282(ra) # 80005dce <uartstart>
      release(&uart_tx_lock);
    80005ef0:	8526                	mv	a0,s1
    80005ef2:	00000097          	auipc	ra,0x0
    80005ef6:	1d4080e7          	jalr	468(ra) # 800060c6 <release>
}
    80005efa:	70a2                	ld	ra,40(sp)
    80005efc:	7402                	ld	s0,32(sp)
    80005efe:	64e2                	ld	s1,24(sp)
    80005f00:	6942                	ld	s2,16(sp)
    80005f02:	69a2                	ld	s3,8(sp)
    80005f04:	6a02                	ld	s4,0(sp)
    80005f06:	6145                	addi	sp,sp,48
    80005f08:	8082                	ret

0000000080005f0a <uartgetc>:
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    ...
    80005f14:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    80005f18:	8b85                	andi	a5,a5,1
    80005f1a:	cb91                	beqz	a5,80005f2e <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    80005f1c:	100007b7          	lui	a5,0x10000
    80005f20:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    80005f24:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    80005f28:	6422                	ld	s0,8(sp)
    80005f2a:	0141                	addi	sp,sp,16
    80005f2c:	8082                	ret
    return -1;
    80005f2e:	557d                	li	a0,-1
    80005f30:	bfe5                	j	80005f28 <uartgetc+0x1e>

0000000080005f32 <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    ...
    80005f3e:	a029                	j	80005f48 <uartintr+0x16>
      break;
    consoleintr(c);
    80005f40:	00000097          	auipc	ra,0x0
    80005f44:	914080e7          	jalr	-1772(ra) # 80005854 <consoleintr>
    int c = uartgetc();
    80005f48:	00000097          	auipc	ra,0x0
    80005f4c:	fc2080e7          	jalr	-62(ra) # 80005f0a <uartgetc>
    if(c == -1)
    80005f50:	fe9518e3          	bne	a0,s1,80005f40 <uartintr+0xe>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    80005f54:	00020497          	auipc	s1,0x20
    80005f58:	2b448493          	addi	s1,s1,692 # 80026208 <uart_tx_lock>
    80005f5c:	8526                	mv	a0,s1
    80005f5e:	00000097          	auipc	ra,0x0
    80005f62:	0b4080e7          	jalr	180(ra) # 80006012 <acquire>
  uartstart();
    80005f66:	00000097          	auipc	ra,0x0
    80005f6a:	e68080e7          	jalr	-408(ra) # 80005dce <uartstart>
  release(&uart_tx_lock);
    80005f6e:	8526                	mv	a0,s1
    80005f70:	00000097          	auipc	ra,0x0
    80005f74:	156080e7          	jalr	342(ra) # 800060c6 <release>
}
...
{
    80005f82:	1141                	addi	sp,sp,-16
    80005f84:	e422                	sd	s0,8(sp)
    80005f86:	0800                	addi	s0,sp,16
  lk->name = name;
    80005f88:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    80005f8a:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    80005f8e:	00053823          	sd	zero,16(a0)
}
    80005f92:	6422                	ld	s0,8(sp)
    80005f94:	0141                	addi	sp,sp,16
    80005f96:	8082                	ret

0000000080005f98 <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80005f98:	411c                	lw	a5,0(a0)
    80005f9a:	e399                	bnez	a5,80005fa0 <holding+0x8>
    ...
    80005f9e:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80005faa:	6904                	ld	s1,16(a0)
    80005fac:	ffffb097          	auipc	ra,0xffffb
    80005fb0:	e7a080e7          	jalr	-390(ra) # 80000e26 <mycpu>
    80005fb4:	40a48533          	sub	a0,s1,a0
    80005fb8:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80005fd0:	100024f3          	csrr	s1,sstatus
    80005fd4:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80005fd8:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80005fda:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    80005fde:	ffffb097          	auipc	ra,0xffffb
    80005fe2:	e48080e7          	jalr	-440(ra) # 80000e26 <mycpu>
    80005fe6:	5d3c                	lw	a5,120(a0)
    80005fe8:	cf89                	beqz	a5,80006002 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    80005fea:	ffffb097          	auipc	ra,0xffffb
    80005fee:	e3c080e7          	jalr	-452(ra) # 80000e26 <mycpu>
    80005ff2:	5d3c                	lw	a5,120(a0)
    80005ff4:	2785                	addiw	a5,a5,1
    80005ff6:	dd3c                	sw	a5,120(a0)
}
    ...
    80006006:	e24080e7          	jalr	-476(ra) # 80000e26 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    8000600a:	8085                	srli	s1,s1,0x1
    8000600c:	8885                	andi	s1,s1,1
    8000600e:	dd64                	sw	s1,124(a0)
    80006010:	bfe9                	j	80005fea <push_off+0x24>

0000000080006012 <acquire>:
{
  ...
  push_off(); // disable interrupts to avoid deadlock.
    ...
    80006022:	fa8080e7          	jalr	-88(ra) # 80005fc6 <push_off>
  if(holding(lk))
    80006026:	8526                	mv	a0,s1
    80006028:	00000097          	auipc	ra,0x0
    8000602c:	f70080e7          	jalr	-144(ra) # 80005f98 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    80006030:	4705                	li	a4,1
  if(holding(lk))
    80006032:	e115                	bnez	a0,80006056 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    80006034:	87ba                	mv	a5,a4
    80006036:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    8000603a:	2781                	sext.w	a5,a5
    8000603c:	ffe5                	bnez	a5,80006034 <acquire+0x22>
  __sync_synchronize();
    8000603e:	0ff0000f          	fence
  lk->cpu = mycpu();
    80006042:	ffffb097          	auipc	ra,0xffffb
    80006046:	de4080e7          	jalr	-540(ra) # 80000e26 <mycpu>
    8000604a:	e888                	sd	a0,16(s1)
}
    ...
    8000605a:	78a50513          	addi	a0,a0,1930 # 800087e0 <digits+0x20>
    8000605e:	00000097          	auipc	ra,0x0
    80006062:	a78080e7          	jalr	-1416(ra) # 80005ad6 <panic>

0000000080006066 <pop_off>:
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80006072:	db8080e7          	jalr	-584(ra) # 80000e26 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006076:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    8000607a:	8b89                	andi	a5,a5,2
  if(intr_get())
    8000607c:	e78d                	bnez	a5,800060a6 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    8000607e:	5d3c                	lw	a5,120(a0)
    80006080:	02f05b63          	blez	a5,800060b6 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    80006084:	37fd                	addiw	a5,a5,-1
    80006086:	0007871b          	sext.w	a4,a5
    8000608a:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    8000608c:	eb09                	bnez	a4,8000609e <pop_off+0x38>
    8000608e:	5d7c                	lw	a5,124(a0)
    80006090:	c799                	beqz	a5,8000609e <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006092:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    80006096:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800060aa:	74250513          	addi	a0,a0,1858 # 800087e8 <digits+0x28>
    800060ae:	00000097          	auipc	ra,0x0
    800060b2:	a28080e7          	jalr	-1496(ra) # 80005ad6 <panic>
    panic("pop_off");
    800060b6:	00002517          	auipc	a0,0x2
    800060ba:	74a50513          	addi	a0,a0,1866 # 80008800 <digits+0x40>
    800060be:	00000097          	auipc	ra,0x0
    800060c2:	a18080e7          	jalr	-1512(ra) # 80005ad6 <panic>

00000000800060c6 <release>:
{
  ...
  if(!holding(lk))
    ...
    800060d6:	ec6080e7          	jalr	-314(ra) # 80005f98 <holding>
    800060da:	c115                	beqz	a0,800060fe <release+0x38>
  lk->cpu = 0;
  ...
  pop_off();
    ...
    800060f0:	f7a080e7          	jalr	-134(ra) # 80006066 <pop_off>
}
    ...
    80006102:	70a50513          	addi	a0,a0,1802 # 80008808 <digits+0x48>
    80006106:	00000097          	auipc	ra,0x0
    8000610a:	9d0080e7          	jalr	-1584(ra) # 80005ad6 <panic>
	...
